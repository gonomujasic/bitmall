...
<hr width='900' size='3'>
<form name="form1" method="post" action="/admin/opts_new">
...
<table width="500" border="1" cellspacing="0" bordercolordark="white" bordercolorlight="black">
	<tr> 
		...
		<td width="400" height="20"  bgcolor="#F2F2F2">
			<input type="hidden" name="optNo" value="${no }" size="20" maxlength="20">
...
<table width="500" border="0" cellspacing="0" cellpadding="7">
	<tr> 
		<td align="center">
			...
			<a href="/admin/opts?no=${no}"><input type="button" value="이 전 화 면"></a>
		</td>
	</tr>
</table>
